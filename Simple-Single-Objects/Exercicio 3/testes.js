...
const atmteste = new ATM (56000);
console.log(atmteste.numeroSerie === 56000);
// a linha a seguir não deve fazer efeito
atmteste.numeroSerie = 120000;
console.log(atmteste.numeroSerie === 56000);
// o ATM inicia zerado
console.log(atmteste.valor); // zerado
console.log(atmteste.valor === 540) // resulta em false
// abastecendo
atmteste.abastecer(300, 100);
atmteste.abastecer(300, 50);
atmteste.abastecer(300, 20);
atmteste.abastecer(300, 10);
atmteste.abastecer(300, 5);
// verificando a quantidade de cédulas
console.log(atmteste.cedulas(100)); // 300
console.log(atmteste.cedulas(50)); // 300
console.log(atmteste.cedulas(20)); // 300
console.log(atmteste.cedulas(10)); // 300
console.log(atmteste.cedulas(5)); // 300
console.log(atmteste.cedulas(50) === 300); // true
// total do ATM é de R$ 55,500.00
console.log(atmteste.valor === 55500);
atmteste.retirar(780);
console.log(atmteste.valor === 54720);
console.log(atmteste.valor) //54720
atmteste.abastecer(5, 20);
atmteste.abastecer(5, 10);
atmteste.abastecer(5, 5);
//54720 + 175 = 54895
atmteste.retirar(580);
//54895 - 580 = 54315
console.log(atmteste.valor) //54315
console.log(atmteste.valor === 400) //false
atmteste.retirar(49775);
